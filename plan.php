...
<body>
	...
	<div class="plan-whole-wrapper">
		...
		<div class="section section--1">
			<div class="p-section section--table section--left p-guest">
				<div class="section--t-cell">
		        	...
		        	<p class="guests-value p-section__value"></p>
		        </div>
			</div>

			<div class="p-section section--table section--right p-budget">
				<div class="section--t-cell">
					<p class="plan__main-content__section-heading">Per Guest Budget</p>
		            <input type="text" id="budget" name="example_name" value="" />
		            <p class="budget-value p-section__value"></p>
		        </div>
			</div>
		...
		<div class="section section--2">
			<div class="p-section section--table section--left p-date">
				<div class="section--t-cell">
			...
			<div class="p-section section--table section--right p-time">
				<div class="section--t-cell">
